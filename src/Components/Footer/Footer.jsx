      ...
      <section class="py-10 bg-gray-100 sm:pt-16 lg:pt-24">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              ...
              <div className="footertitle">
                <h1 className="footermaintitle">GEBEYA</h1>
                ...
                <ul class="flex items-center space-x-3 mt-9">
                  <li className="socialmediaicons">
                    <a
                      href="#"
                      title=""
                      class="flex items-center justify-center text-white transition-all duration-200 bg-blue-600 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600"
                    >
                      <svg
                        class="w-4 h-4"
                        viewBox="0 0 24 24"
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
              ...
              <form action="#" method="POST" class="mt-6">
                ...
                <button
                  type="submit"
                  class="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-blue-600 "
                >
                  Subscribe
                </button>
              </form>
          ...
          <p class="text-sm text-center text-gray-600">
            © Copyright 2021, All Rights Reserved by Gebeya
          </p>
        </div>
      </section>
    </div>
